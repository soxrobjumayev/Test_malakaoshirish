...
create table natija (
    natija_id serial primary key,
    user_id int references users(user_id),
    ball INT DEFAULT NULL,
    natija_ikki_id int references natija_ikki(natija_ikki_id),
    Table_Chapter_id int references Table_Chapter(Table_Chapter_id)


);

create table natija_ikki (
    natija_ikki_id serial primary key,
...
('Глава 2','Куб кибербезопасности',1); 
...
insert into Table_Chapter(Table_Chapter_number,Table_Chapter_topic) values
('Глава 3','Угрозы кибербезопасности, уязвимости и атак',1); 
...
insert into Table_Chapter(Table_Chapter_number,Table_Chapter_topic) values
('Глава 4','Способы защиты секретной информации',1); 
...
insert into Table_Chapter(Table_Chapter_number,Table_Chapter_topic) values
('Глава 5','Искусство обеспечения целостности данных',1); 
...
insert into Table_Chapter(Table_Chapter_number,Table_Chapter_topic) values
('Глава 6','Концепция «пять девяток»',1); 
...
insert into Table_Chapter(Table_Chapter_number,Table_Chapter_topic) values
('Глава 7','Защита уровней обеспечения кибербезопасности',1); 
...
-- glava  88888888888888888888888888888888888
 ...
 insert into Table_Chapter(Table_Chapter_number,Table_Chapter_topic) values
('Глава 8','Как стать специалистом в области кибербезопасности',1); 
